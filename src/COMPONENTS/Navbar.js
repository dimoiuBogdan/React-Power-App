  ...
  return (
    <div
      ...
      className={`z-10 py-3 fixed left-0 right-0 px-4 text-white ${
        solid ? "bg-gray-600 border-b-4 border-red-400" : ""
      }`}
      style={{
    ...
    >
      <div className="container mx-auto items-center justify-between flex">
        ...
        <div>
          ...
          >
            <div className="h-1 w-full transition duration-1000 rounded-full bg-red-400 my-1"></div>
            <div
              className={`h-1 transition-all delay-100 duration-700 w-4/5 ml-auto rounded-full bg-red-400 my-1 ${
                isVisible ? "w-full" : ""
              }`}
            ></div>
            <div
              className={`h-1 transition-all delay-300 duration-700 w-1/2 ml-auto rounded-full bg-red-400 my-1 ${
                isVisible ? "w-full" : ""
              }`}
            ></div>
          </div>
          ...
          >
            ...
            <NavLink
              activeClassName="active-link"
              to="/add-post"
              className="mx-4 flex items-center lg:mr-8 cursor-pointer transition-all hover:text-red-400 transform hover:scale-105"
            >
              Post
            </NavLink>
            <SignOut />
